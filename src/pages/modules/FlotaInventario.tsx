...
const COLUMN_LABELS: Record<string, string> = {
  ...
  permiso_explotacion_unidad: "Permiso de Explotacion de la Unidad",
  fecha_autorizacion_explotacion: "Fecha de Autorizacion de Explotacion de la Unidad",
  fecha_vencimiento_explotacion: "Fecha de Vencimiento de Explotacion de la Unidad",
  permiso_circulacion: "Permiso de Circulacion",
  fecha_autorizacion_circulacion: "Fecha de Autorizacion de Circulacion",
  fecha_vencimiento_circulacion: "Fecha de Vencimiento de Circulacion",
  permiso_publicidad: "Permiso de Publicidad",
  fecha_autorizacion_publicidad: "Fecha de Autorizacion de Publicidad",
  fecha_vencimiento_publicidad: "Fecha de Vencimiento de Publicidad",
  permisos_especiales: "Permisos Especiales",
  fecha_autorizacion_especiales: "Fecha de Autorizacion de Permisos Especiales",
  fecha_vencimiento_especiales: "Fecha de Vencimiento de Permisos Especiales",
};
